...
public class SimpleAnimationOrig implements IAnimationModelOrig {
  ...
  public void addAction(ITimedAction action) {
    if (!this.shapes.contains(action.getShape())) {
      throw new IllegalArgumentException("SimpleAnimationOrig.getShapeStateAt(int, Shape) -- "
  ...
  public void addShape(IAnimationPiece shape) throws IllegalArgumentException {
    if (findShape(shape.getName(), this.shapes) != null) {
      throw new IllegalArgumentException("SimpleAnimationOrig.addShape(Shape) -- "
  ...
  /**
   * Represents a builder for a new SimpleAnimationOrig.
   */
  public static final class Builder implements TweenModelBuilder<IAnimationModelOrig> {
     ...
     */
    public static TweenModelBuilder<IAnimationModelOrig> initialize() {
      return new Builder();
    }

    @Override
    public TweenModelBuilder<IAnimationModelOrig> addOval(String name, float cx, float cy,
    ...
    @Override
    public TweenModelBuilder<IAnimationModelOrig> addRectangle(String name, float lx, float ly,
    ...
    @Override
    public TweenModelBuilder<IAnimationModelOrig> addMove(String name, float moveFromX,
                                                          float moveFromY,
                                                          float moveToX, float moveToY,
                                                          int startTime, int endTime) {
      this.actionsToAdd.add(AnimationActionBuilder.initialize()
              .setTargetShape((Shape) SimpleAnimationOrig.findShape(name, this.shapesToAdd))
    ...
    @Override
    public TweenModelBuilder<IAnimationModelOrig> addColorChange(String name, float oldR,
                                                                 float oldG,
    ...
    @Override
    public TweenModelBuilder<IAnimationModelOrig> addScaleToChange(String name, float fromSx,
    ...
    @Override
    public IAnimationModelOrig build() {
      IAnimationModelOrig animationModel = new SimpleAnimationOrig();
